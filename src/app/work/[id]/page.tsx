...
export default async function ProjectDetailPage({ params }: { params: { id: string } }) {
    ...
    const { id } = params; // langsung destructure, gak perlu await
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <div className="max-w-6xl mx-auto px-6 pb-16 pt-16">
                ...
                {images.length > 0 && (
                    <div className="bg-white rounded-2xl shadow-lg p-8 mb-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {images.map((img, idx) => (
                                <div key={idx} className="relative w-full h-80 rounded-xl overflow-hidden group">
                                    <Image src={img} alt={project.title} fill className="object-cover transition-transform duration-500 group-hover:scale-105" />
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-6">Detail Project</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        {project.tags && (
                            <div>
                                <h3 className="text-lg font-medium text-gray-700 mb-3">Teknologi yang Digunakan</h3>
